...
![Graphique quantiles-quantiles - Adéquation à la loi Normale](/assets/img/anova_temps_production/qqplot.png "Étude graphique de l'adéquation à la loi Normale.")
...
print(f"Satistic {statistic}, pvalue : {pvalue}")
```
Voici le résultat du test d'adéquation : 
il y a peu d'évidence pour que les données ne soient pas normalement distribuée. 
{% endtab %}
...
La pvalue est supérieure au seuil de significativité : nous ne pouvons pas rejeter l'hypothèse nulle. 
{% endtab %}
